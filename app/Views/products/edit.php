...
<section>
    ...
    <form action="/products/update/<?= $product['id'] ?>" method="post" enctype="multipart/form-data">
        ...
        <div class="mb-3">
            ...
            <input type="number" class="form-control" name="price" value="<?= esc($product['price']) ?>" id="price">
        </div>
        <div class="mb-3">
            <label for="description" class="form-label">Description</label>
            <input type="text" class="form-control" name="description" value="<?= esc($product['description']) ?>" id="description">
        </div>
        <div class="mb-3">
